...
import { ViewCarritoComponent } from './components/view-carrito/view-carrito.component';  // Importa el componente
...
export const routes: Routes = [
    ...
    { path: "carrito", component: ViewCarritoComponent }  // Nueva ruta para el carrito
];
